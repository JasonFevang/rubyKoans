...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes the function call number and sets that to sum, then performs the operation in {}
    # using the inside as sum and the first array element as item. Then the result becomes sum and
    # it runs it again on the next array element
  end
  ...
  # We did it that way because that way you don't need to close the file, the file closes automatically
